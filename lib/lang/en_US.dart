const Map<String, String> en_US = {
  ...
  'find_your_business': 'Find your business',
  'furniture': 'FURNITURE',
  'activity': 'ACTIVIDAD',
  'franchise': 'FRANCHISE',
  'supplier': 'SUPPLIER',
  ...
  'keep_searching': 'Featured ads',
  'actual_country': 'all in city',
  'view_all': 'View all',
  'coin': ' \$',
  'ad_view_early': 'Recently seen',
  'starts_to': 'Starts to',
  'create_ad':
      'Give your used one a second chance: sell what you no longer use.',
  'place_ad': 'Publish your ad',
  'loading': 'Loading...',
  'create_ad_titie_create_ad': 'Post your ad',
  'create_ad_subtitie_create_ad': 'Choose from the categories',
  'create_ad_category_one': 'Do you sell or buy equipment or businesses?',
  'create_ad_category_two': 'Choose from the categories',
  'sell': 'Sell',
  'buy': 'Buy',
  'rent': 'Rent',
  'rent2': 'Rent',
  "find_sell": "Search for sellers",
  "find_buy": "Search for buyers",
  "find_rent": "Search for renters",
  "find_rent2": "Search for renters",
  'ad_not_available' : 'Advertisement not available',

  //SHOW AD SCREEN
  'autor_ad': 'Published by',
  'subcategory_ad': 'Subcategory',
  'adtype_ad': 'Ad Type',
  'peopletype_ad': 'People Type',
  'description_ad': 'Description',
  'condition_ad': 'Condition',
  'edit_ad': 'Edit ad',
  'contact_ad': 'Contact',
  ...
  'write_anything': 'Type something',
  'money_range': 'Price Range',
  'no_ad': 'There are no ads posted',
  'label1_nav': 'Home',
  'label2_nav': 'Favorites',
  'label3_nav': 'Publish',
  'label4_nav': 'Messages',
  'label5_nav': 'Me',
  ...
  'join_horecah2':
      'You will find everything you need in the world of Hotels, Restaurant and Catering.',
  ...
  'Searching an adviser': 'Searching an adviser',
  ...
  'Like new (slightly used)': 'Like new (slightly used)',
  ...
  'free_payment': 'Free Option',
  'paid_option': 'Paid Option',
  'select a duration': 'Select a duration',
  'on display for 1 day': 'On display for 1 day',
  'on display for 7 days': 'On display for 7 days',
  'on display for 1 month': 'On display for 1 month',
  'on display for 2 months': 'On display for 2 months',
  'free_public': 'Free to publish',
  'require_insert' : 'Requires to insert.',
  'require_least' : 'Requires at least 5 characters.',
  'email_format' : 'Insert in correct format.',
};
